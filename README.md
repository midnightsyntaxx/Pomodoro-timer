# 🍅 Pomodoro Timer - Tingkatkan Fokus Belajarmu

A sleek, functional, and perfectly centered Pomodoro Timer. Aplikasi berbasis web ini dibuat untuk membantu pengguna mengelola waktu belajar atau bekerja dengan teknik Pomodoro, dikemas dengan tampilan yang bersih dan minimalis

## 📂 Folder Structure

Berikut adalah struktur folder proyek yang telah dirapikan untuk kemudahan pemeliharaan:

```text
pomodoro-timer/
├── assets/
│   └── images/          # Menyimpan aset gambar & wallpaper
├── css/
│   └── style.css        # Semua styling, layout, dan desain responsif
├── js/
│   └── script.js        # Logika utama timer dan kontrol DOM
